...
fish_add_path -aP $HOME/.local/bin $HOME/Applications $HOME/Scripts
fish_add_path -aP $XDG_DATA_HOME/npm/bin
fish_add_path -aP $CARGO_HOME/bin
fish_add_path -aP $HOME/Applications/bat-extras/src
fish_add_path -aP $HOME/Applications/omnisharp
